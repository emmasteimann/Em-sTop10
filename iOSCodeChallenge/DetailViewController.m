...
- (id)initWithNSDictionary:(NSDictionary *)detailDictionary
{
    ...
    if (self){
        ...
        UIBarButtonItem *navigationBackButton = [[UIBarButtonItem alloc] initWithTitle:@"Show" style:UIBarButtonItemStylePlain target:self action:@selector(targetForNavigationButton:)];
